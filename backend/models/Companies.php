...
class Companies extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['company_id'], 'integer'],
            [['company_name', 'company_email', 'company_address', 'company_status'], 'string', 'max' => 191],
            [['company_created_date'], 'string', 'max' => 19],
        ];
    }
    ...
    {
        return $this->hasMany(Department::className(),['companies_company_id' => 'company_id']);
    }
